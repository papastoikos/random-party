...
const DICE_WIDTH = 30;
const NUMBER_OF_DICE = 7;
const SUMMON_CONTROL_BUTTON_HEIGHT = 50;
const SUMMON_CONTROL_BUTTON_WIDTH = 50;
const CONTROL_PANEL_TITLE_BAR_HEIGHT = 50;
const CONTROL_PANEL_HEIGHT = (DICE_HEIGHT * 12) + CONTROL_PANEL_TITLE_BAR_HEIGHT;
const CONTROL_PANEL_WIDTH = DICE_WIDTH * 14;
